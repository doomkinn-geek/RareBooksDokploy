...
namespace RareBooksService.Data.Migrations.UsersDb
{
    ...
    [Migration("20251118181158_AddUserCollectionFeature")]
    partial class AddUserCollectionFeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RareBooksService.Common.Models.RegularBaseBook", b =>
                {
                    ...
                    b.Property<List<string>>("ThumbnailUrls")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("RareBooksService.Common.Models.SubscriptionPlan", b =>
                {
                    ...
                    b.Property<bool>("HasCollectionAccess")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("RareBooksService.Common.Models.UserCollectionBook", b =>
                {
                    ...
                    b.Property<bool>("IsManuallyPriced")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("RareBooksService.Common.Models.UserCollectionBookImage", b =>
                {
                    ...
                    b.Property<int>("UserCollectionBookId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RareBooksService.Common.Models.UserCollectionBook", b =>
                {
                    b.HasOne("RareBooksService.Common.Models.RegularBaseBook", "ReferenceBook")
                        .WithMany()
            ...
            modelBuilder.Entity("RareBooksService.Common.Models.UserCollectionBookImage", b =>
                {
                    b.HasOne("RareBooksService.Common.Models.UserCollectionBook", "UserCollectionBook")
                        .WithMany("Images")
                        .HasForeignKey("UserCollectionBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserCollectionBook");
                });

            modelBuilder.Entity("RareBooksService.Common.Models.UserCollectionBookMatch", b =>
                {
                    b.HasOne("RareBooksService.Common.Models.RegularBaseBook", "MatchedBook")
                        .WithMany()
                        .HasForeignKey("MatchedBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RareBooksService.Common.Models.UserCollectionBook", "UserCollectionBook")
                        .WithMany("SuggestedMatches")
                        .HasForeignKey("UserCollectionBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MatchedBook");
