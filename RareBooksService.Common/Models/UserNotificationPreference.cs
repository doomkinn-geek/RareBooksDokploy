...
namespace RareBooksService.Common.Models
{
    ...
    public class UserNotificationPreference
    {
        ...
        /// <summary>
        /// Использовать точное совпадение ключевых слов вместо поиска по частям слов и склонениям
        /// false = нечеткий поиск (по умолчанию): "история" найдет "историю", "истории", "историй" и т.д.
        /// true = точное совпадение: "история реформации" найдет только точную фразу
        /// </summary>
