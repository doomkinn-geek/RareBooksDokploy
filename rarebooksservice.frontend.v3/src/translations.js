...
const translations = {
    ...
    RU: {
        ...
        editNotification: 'Редактировать настройку',
        deleteNotification: 'Удалить настройку',
        enabled: 'Включено',
        disabled: 'Отключено',
        keywords: 'Ключевые слова',
        keywordsHint: 'Введите ключевые слова через запятую (например: Пушкин, прижизненное издание)',
        categories: 'Категории',
        categoriesHint: 'ID категорий через запятую (оставьте пустым для всех)',
        cities: 'Города',
        citiesHint: 'Города через запятую (оставьте пустым для всех)',
        priceRange: 'Ценовой диапазон',
        yearRange: 'Диапазон лет издания',
        frequency: 'Частота уведомлений',
        frequencyMinutes: 'минут',
        ...
        error: 'Ошибка',
        success: 'Успешно',
        noNotifications: 'У вас пока нет настроек уведомлений',
        createFirstNotification: 'Создайте первую настройку уведомлений',
        lastNotificationSent: 'Последнее уведомление отправлено',
        
        // Telegram подключение
        telegramConnectionInstructions: 'Инструкции по подключению Telegram',
        step1: 'Шаг 1',
        step2: 'Шаг 2', 
        step3: 'Шаг 3',
        findBot: 'Найдите бота @RareBooksReminderBot в Telegram',
        startBot: 'Нажмите /start или отправьте любое сообщение боту',
        getIdFromBot: 'Бот отправит вам ваш Telegram ID',
        enterIdHere: 'Введите полученный ID в поле выше и нажмите "Подключить"',
        
        // Сообщения
        telegramConnectedSuccess: 'Telegram успешно подключен!',
        telegramDisconnectedSuccess: 'Telegram отключен!',
        testNotificationSent: 'Тестовое уведомление отправлено!',
        notificationCreated: 'Настройка уведомлений создана!',
        notificationUpdated: 'Настройка уведомлений обновлена!',
        notificationDeleted: 'Настройка уведомлений удалена!',
        confirmDelete: 'Вы уверены, что хотите удалить эту настройку?',
        
        // Поля форм
        minYear: 'Минимальный год',
        maxYear: 'Максимальный год',
        notificationFrequency: 'Частота уведомлений (минуты)',
        enterTelegramId: 'Введите ваш Telegram ID',
        enterTelegramUsername: 'Введите ваш Telegram username (необязательно)',
        ...
        content: 'Содержание',
        bookTitle: 'Название книги',
        noHistory: 'История уведомлений пуста'
    },
