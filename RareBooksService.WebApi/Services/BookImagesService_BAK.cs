...
{
    public interface IBookImagesService_BAK
    {
    ...
    public class BookImagesService_BAK : IBookImagesService
    {
        private readonly ILogger<BookImagesService_BAK> _logger;
        ...
        public BookImagesService_BAK(ILogger<BookImagesService_BAK> logger,
